...
/*
 * File: Arduino_DataFlash_WriteByte.c
 *
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sat Aug 11 00:52:49 2012
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Arduino_DataFlash_WriteByte
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          1
/* Input Port  0 */
#define IN_PORT_0_NAME      c
...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      colnum
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *colnum  = (const real_T *)mxGetData(PARAM_DEF0(S));
