...
/*
 * File: Arduino_DataFlash_WriteFloats.c
 *
 *
  *
...
#define S_FUNCTION_NAME Arduino_DataFlash_WriteFloats
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 2, 2, "precision", ssGetDataTypeId(S, "int32"));
}
