...
extern void s2b_Outputs_wrapper(const real32_T *u0,
                          uint8_T *y0);
...
{
    const real32_T   *u0  = (const real32_T*) ssGetInputPortSignal(S,0);
    uint8_T        *y0  = (uint8_T *)ssGetOutputPortRealSignal(S,0);

    s2b_Outputs_wrapper(u0, y0);
}
