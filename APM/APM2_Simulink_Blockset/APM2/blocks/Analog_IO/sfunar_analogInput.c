...
/*
 *   sfunar_analogInput.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this SFunction is to call a simple legacy
 *     function during simulation:
 *
 *        int16 y1 = analogRead(int16 p1)
 *
 *   Simulink version           : 7.3 (R2009a) 15-Jan-2009
 *   C source code generated on : 06-Jul-2009 17:31:04
 ...
 */
#define S_FUNCTION_NAME                sfunar_analogInput
...
{
  const real_T * const sampleTime = (real_T*) (mxGetPr(SAMPLE_TIME));
  const size_t stArraySize = mxGetM(SAMPLE_TIME) * mxGetN(SAMPLE_TIME);
