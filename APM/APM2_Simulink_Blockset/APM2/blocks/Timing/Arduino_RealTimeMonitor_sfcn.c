...
/*
 * File: Arduino_RealTimeMonitor_sfcn.c
 *
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Wed Aug  8 23:14:38 2012
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Arduino_RealTimeMonitor_sfcn
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      isrealtime
...
{
    boolean_T        *isrealtime  = (boolean_T *)ssGetOutputPortRealSignal(S,0);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T  *SampleTime  = (const real_T *)mxGetData(PARAM_DEF0(S));

    /* Arduino_RealTimeMonitor_sfcn_Outputs_wrapper(isrealtime, SampleTime, p_width0); */
}
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 0, 0, "SampleTime", ssGetDataTypeId(S, "double"));
}
