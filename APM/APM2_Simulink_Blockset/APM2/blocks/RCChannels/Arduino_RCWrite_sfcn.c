 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Jul 24 23:15:27 2012
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Arduino_RCWrite_sfcn
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
{
    const uint16_T   *ch1  = (const uint16_T*) ssGetInputPortSignal(S,0);
    const uint16_T   *ch2  = (const uint16_T*) ssGetInputPortSignal(S,1);
    const uint16_T   *ch3  = (const uint16_T*) ssGetInputPortSignal(S,2);
    const uint16_T   *ch4  = (const uint16_T*) ssGetInputPortSignal(S,3);
    const uint16_T   *ch5  = (const uint16_T*) ssGetInputPortSignal(S,4);
    const uint16_T   *ch6  = (const uint16_T*) ssGetInputPortSignal(S,5);
    const uint16_T   *ch7  = (const uint16_T*) ssGetInputPortSignal(S,6);
    const uint16_T   *ch8  = (const uint16_T*) ssGetInputPortSignal(S,7);

    uint16_T   *ch1_out  = (uint16_T*) ssGetOutputPortSignal(S,0);
    uint16_T   *ch2_out  = (uint16_T*) ssGetOutputPortSignal(S,1);
    uint16_T   *ch3_out  = (uint16_T*) ssGetOutputPortSignal(S,2);
    uint16_T   *ch4_out  = (uint16_T*) ssGetOutputPortSignal(S,3);
    uint16_T   *ch5_out  = (uint16_T*) ssGetOutputPortSignal(S,4);
    uint16_T   *ch6_out  = (uint16_T*) ssGetOutputPortSignal(S,5);
    uint16_T   *ch7_out  = (uint16_T*) ssGetOutputPortSignal(S,6);
    uint16_T   *ch8_out  = (uint16_T*) ssGetOutputPortSignal(S,7);
