...
class AP_InertialSensor_MPU6000 : public AP_InertialSensor
{
  ...
  AP_InertialSensor_MPU6000( uint8_t cs_pin );
    ...
    uint16_t init( AP_PeriodicProcess * scheduler, unsigned int lpf_filt_freq_hz,  unsigned int gyro_scale, unsigned int accel_scale );
  ...
  static void hardware_init(unsigned int lpf_filt_freq_hz, 
