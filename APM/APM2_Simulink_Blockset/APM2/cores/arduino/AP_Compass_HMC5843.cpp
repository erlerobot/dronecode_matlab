...
AP_Compass_HMC5843::init()
{
  ...
  if ( _base_config == (SampleAveraging_8<<5 | DataOutputRate_75HZ<<2 | NormalOperation)) {
	 ...
	 // gain_multiple = 0.6055046; // 660.0 / 1090;  adjustment for runtime vs calibration gain
	 gain_multiple = 1; // just want the raw data 
  ...
  while ( success == 0 && numAttempts < 20 && good_count < 5)
  {
	  ...
	  // force positiveBias (compass should return 715 or 766/713 for all channels)
	  ...
	  Serial2.print(mag_y);
	  Serial2.print(" mag_z: ");
	  Serial2.println(mag_z);
	  Serial2.print("CalX: ");
	  Serial2.print(calibration[0]/good_count);
	  Serial2.print(" CalY: ");
	  Serial2.print(calibration[1]/good_count);
	  Serial2.print(" CalZ: ");
	  Serial2.println(calibration[2]/good_count);
#endif
  }
