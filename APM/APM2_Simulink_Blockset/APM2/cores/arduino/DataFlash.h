...
#define DF_OVERWRITE_DATA 0 // 0: When reach the end page stop, 1: Start overwriting from page 1
...
class DataFlash_Class
{
  ...
  public:
	...
	void WriteFloat(float data); // ADDED BY RFH FOR ERAU
	...
	int16_t ReadInt();
	int32_t ReadLong();
	float ReadFloat(); // ADDED BY RFH FOR ERAU
